...
`[0, 1]`. Well-formed nonembedding codes exist against it, unlike the one-generator
`succAge`, where every well-formed code is actual. -/
def succAge2 : ComputableAgeIn O succLang :=
  { succAge O with
    gens := fun _ ↦ [0, 1]
